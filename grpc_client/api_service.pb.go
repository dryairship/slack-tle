...
func (x *RatingRequest) GetHandles() []string {
	if x != nil {
		return x.Handles
	}
	return nil
...
func (x *RatingReply) GetFile() string {
	if x != nil {
		return x.File
	}
	return ""
...
var file_api_service_proto_rawDesc = []byte{
	...
	,
...
var file_api_service_proto_goTypes = []interface{}{
	(*RatingRequest)(nil), // 0: RatingRequest
	(*RatingReply)(nil),   // 1: RatingReply
}
var file_api_service_proto_depIdxs = []int32{
	0, // 0: APIService.GetRating:input_type -> RatingRequest
	1, // 1: APIService.GetRating:output_type -> RatingReply
...
type APIServiceClient interface {
	GetRating(ctx context.Context, in *RatingRequest, opts ...grpc.CallOption) (*RatingReply, error)
}
...
func (c *aPIServiceClient) GetRating(ctx context.Context, in *RatingRequest, opts ...grpc.CallOption) (*RatingReply, error) {
	out := new(RatingReply)
	err := c.cc.Invoke(ctx, "/APIService/GetRating", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServiceServer interface {
	GetRating(context.Context, *RatingRequest) (*RatingReply, error)
}
...
func (*UnimplementedAPIServiceServer) GetRating(context.Context, *RatingRequest) (*RatingReply, error) {
...
func _APIService_GetRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RatingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServiceServer).GetRating(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/APIService/GetRating",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).GetRating(ctx, req.(*RatingRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _APIService_GetRating_Handler,
		},
	},
